...
# This looks up your Route 53 hosted zone for "sketchy.gg"
data "aws_route53_zone" "primary" {
  name = var.hosted_zone_name
}

# This requests a new ACM certificate
resource "aws_acm_certificate" "sketchy_cert" {
  ...
  tags = {
    Name = "sketchy-gg-cert"
  }
}

# This creates the necessary DNS record to prove you own the domain
resource "aws_route53_record" "cert_validation" {
  for_each = {
    for dvo in aws_acm_certificate.sketchy_cert.domain_validation_options : dvo.domain_name => {
...
# This resource waits for AWS to validate the certificate
resource "aws_acm_certificate_validation" "sketchy_cert_validation" {
  certificate_arn         = aws_acm_certificate.sketchy_cert.arn
